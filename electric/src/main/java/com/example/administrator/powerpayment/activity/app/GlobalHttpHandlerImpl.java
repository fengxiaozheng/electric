...
import com.example.administrator.powerpayment.activity.mvp.model.entity.APIBodyData;
    ...
    public Response onHttpResultResponse(String httpResult, Interceptor.Chain chain, Response response) {
        ...
        if (response.request().url().toString().contains("payexpress")) {
            ...
            try {
                ...
                if (response.request().url().toString().contains("citizen-restful/government/arch")) {
